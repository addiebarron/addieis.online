...
<style lang="scss">
  ...
  .home {
    ...
    .me {
      ...
      @include mixins.transition((transform), 0.2s, ease);
    }
    .about-me {
      font-size: 18px;
      a:focus {
  ...
  <div class="about-me">
    <div class="text">
      ...
      <p>
        ...
        <Link to="https://outschool.com" newTab>Outschool</Link>.
      </p>
      <p>
        ...
        using
        <Link to="https://kit.svelte.dev" newTab>SvelteKit</Link>.
      </p>
      <p>
      ...
      <p>
        ...
        <Link to="https://pcw.fi" newTab>Philly Community Wireless</Link>.
      </p>
      <Socials />
    </div>
  </div>
